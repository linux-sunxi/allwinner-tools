...
cat text.txt | mutt -s "[Daily build] $DATE"  panlong@allwinnertech.com tangliang@allwinnertech.com benn@allwinnertech.com -a  build_err_warn.log pack.log pack_err_warn.log
